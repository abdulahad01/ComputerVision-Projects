...
def main(image_name):
        ...
        draw_ball_contour(binary_image_mask, image_name,contours)
        cv2.waitKey(1)

if __name__ == '__main__':
    vid = '/home/abdu/catkin_ws/src/ros_essentials_cpp/src/topic03_perception/video/tennis-ball-video.mp4'
    cap = cv2.VideoCapture(vid)
    while(True):
        _,image_name = cap.read()
        try :
            main(image_name)
